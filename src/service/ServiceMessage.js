...
export const ServiceMessage = {
    getAllMessages: async (channelId, nbMessage) => {
        return ServiceXhr.callWithAuthNoBody('https://edu.tardigrade.land/msg/protected/channel/'+channelId+'/messages/'+nbMessage, "GET");
    },
